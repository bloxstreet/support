...
Fixed:
- Ratelimited all player-controlled calls to respawn the character
...
Added:
- Confirmation & reason dialog to the cuffs
...
- The shift timer will now be appropriately positioned
