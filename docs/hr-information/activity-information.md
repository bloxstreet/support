...
If an HR is unable to meet an activity requirement or cannot remain active for three or more days, they should create an inactivity notice on [Hyra](https://hyra.io). If an inactivity notice exceeds 21 days, the HR should create a ticket in the [BloxStreet Staffing Support Discord](https://discord.com/invite/5yfvT5fntP).
